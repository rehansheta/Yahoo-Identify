...
public class Extras implements Serializable {
     ...
     *
     * @see com.googlecode.flickrjandroid.groups.pools.PoolsInterface#getPhotos(String, String[], Set, int, int)
     * @see com.googlecode.flickrjandroid.panda.PandaInterface#getPhotos(com.googlecode.flickrjandroid.panda.Panda, Set, int, int)
     * @see com.googlecode.flickrjandroid.people.PeopleInterface#getPublicPhotos(String, Set, int, int)
     * @see com.googlecode.flickrjandroid.photosets.PhotosetsInterface#getPhotos(String, Set, int, int, int)
     * @see com.googlecode.flickrjandroid.photos.PhotosInterface#getContactsPublicPhotos(String, Set, int, boolean, boolean, boolean)
     * @see com.googlecode.flickrjandroid.photos.PhotosInterface#getWithGeoData(java.util.Date, java.util.Date, java.util.Date, java.util.Date, int, String, Set, int, int)
     * @see com.googlecode.flickrjandroid.photos.PhotosInterface#getWithoutGeoData(java.util.Date, java.util.Date, java.util.Date, java.util.Date, int, String, Set, int, int)
     * @see com.googlecode.flickrjandroid.photos.PhotosInterface#recentlyUpdated(java.util.Date, Set, int, int)
     * @see com.googlecode.flickrjandroid.photos.SearchParameters#setExtras(Set)
     * @see com.googlecode.flickrjandroid.photos.geo.GeoInterface#photosForLocation(GeoData, Set, int, int)
     * @see com.googlecode.flickrjandroid.interestingness.InterestingnessInterface#getList(java.util.Date, Set, int, int)
     * @see com.googlecode.flickrjandroid.favorites.FavoritesInterface#getList(String, int, int, Set)
     */
