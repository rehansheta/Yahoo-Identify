...
public class TagsInterface {
	 ...
	 */
	public TagsInterface(String apiKey, String sharedSecret,
	 ...
	 */
	public ClusterList getClusters(String searchTag) throws IOException,
		...
		JSONObject clustersElement = response.getData().getJSONObject(
				"clusters");
	 ...
	 * @throws JSONException
	 */
	public Collection<HotlistTag> getHotList(String period, int count)
			throws IOException, FlickrException, JSONException {
		List<Parameter> parameters = new ArrayList<Parameter>();
	 ...
	 * @throws JSONException
	 */
	public Photo getListPhoto(String photoId) throws IOException,
			FlickrException, JSONException {
		List<Parameter> parameters = new ArrayList<Parameter>();
	 ...
	 * @throws JSONException
	 */
	public Collection<Tag> getListUser(String userId) throws IOException,
			FlickrException, JSONException {
		List<Parameter> parameters = new ArrayList<Parameter>();
	 ...
	 * @throws FlickrException
	 */
	public Collection<Tag> getMostFrequentlyUsed() throws IOException,
			JSONException, FlickrException {
		List<Parameter> parameters = new ArrayList<Parameter>();
		parameters
				.add(new Parameter("method", METHOD_GET_MOST_FREQUENTLY_USED));
	 ...
	 * @throws JSONException
	 */
	public Collection<Tag> getListUserPopular(String userId)
			throws IOException, FlickrException, JSONException {
		List<Parameter> parameters = new ArrayList<Parameter>();
	 ...
	 * @throws JSONException
	 */
	public Collection<TagRaw> getListUserRaw(String tagVal) throws IOException,
			FlickrException, JSONException {
		List<Parameter> parameters = new ArrayList<Parameter>();
	 ...
	 * @throws JSONException
	 */
	public RelatedTagsList getRelated(String tag) throws IOException,
			FlickrException, JSONException {
		List<Parameter> parameters = new ArrayList<Parameter>();
