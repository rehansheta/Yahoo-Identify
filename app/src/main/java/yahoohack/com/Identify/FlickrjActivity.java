package yahoohack.com.Identify;
...
import tasks.GetOAuthTokenTask;
import tasks.OAuthTask;
import tasks.UploadPhotoTask;
...
public class FlickrjActivity extends Activity {
    ...
    private void load(OAuth oauth) {
        if (oauth != null) {
            ...
            UploadPhotoTask taskUpload = new UploadPhotoTask(this, new File(path));
